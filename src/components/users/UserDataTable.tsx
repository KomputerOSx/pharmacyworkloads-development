...
// }
//
// const globalUserFilterFn: FilterFn<User> = (row, columnId, filterValue) => {
//     const searchTerm = String(filterValue).toLowerCase();
//     if (!searchTerm) return true; // Show all rows if search is empty
//
//     const user = row.original;
//     const fullName = `${user.firstName} ${user.lastName}`.toLowerCase();
//     const email = user.email.toLowerCase();
//
//     // Check if search term is included in either full name or email
...
//         globalFilterFn: globalUserFilterFn,
//         state: {
//             sorting,
//             columnFilters,
//             columnVisibility,
...
//                     onChange={
//                         (event) => setGlobalFilter(event.target.value) // Update globalFilter state
//                     }
//                     className="max-w-sm"
//                 />
...
export function UserDataTable({
    users,
    departments, // Receive departments list
    departmentNameMap,
    isLoadingDepartmentMap,
    onEditRequest,
    onDeleteRequest,
