...
import type { ShiftPreset } from "@/types/rotaTypes";
import { getShiftPreset } from "./utils/rota-utils";
    ...
    return (
        <Popover open={popoverOpen} onOpenChange={onPopoverOpenChange}>
            <PopoverTrigger asChild>
                ...
                >
                    {selectedShiftType
                        ? getShiftPreset(selectedShiftType)?.name ||
                          "Select shift"
                        : "Select shift"}
