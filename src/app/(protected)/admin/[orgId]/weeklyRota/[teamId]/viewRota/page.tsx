...
import { useRotaAssignmentsByWeekAndTeam } from "@/hooks/weekly-rota/useRotaAssignments";
import { useWeekStatus } from "@/hooks/weekly-rota/useRotaWeekStatus";
...
import { useIsMobile } from "@/hooks/use-mobile"; // Assuming path is correct
...
export default function ViewRotaPage() {
    ...
    if (isLoading || isMobile === undefined) {
        // Treat undefined isMobile as loading state
        return (
